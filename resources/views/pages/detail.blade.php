...
@section('content')
<div class="page-content pages-detail" style="margin-top: 100px">
                        ...
                        <ul class="list-unstyled">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">ASAP ROCKY</h5>
                            ...
                            <li class="media my-4">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Rocky Gerung</h5>
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Amina Wulandari</h5>
